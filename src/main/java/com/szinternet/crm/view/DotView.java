...
import com.szinternet.crm.utils.ScreenUtils;
...
public class DotView {
    ...
    private void initDot() {
        mDotCircleSpec = ScreenUtils.dpToPxInt(DOT_CIRCLE_SPEC);
        mDotOvalWidth = ScreenUtils.dpToPxInt(DOT_OVAL_WIDTH);
        mDotNoneCountSpec = ScreenUtils.dpToPxInt(DOT_NONE_COUNT_SPEC);
    }
